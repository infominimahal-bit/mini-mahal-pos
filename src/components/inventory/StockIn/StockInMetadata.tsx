    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-2">
          <label className="text-[10px] font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest">{'Transmission Date'}</label>
          <input
            type="date"
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest">{'Internal Ref'}</label>
          <input
      ...
      <div className="flex items-center justify-between bg-[#f8f9fa] dark:bg-black/75 p-4 rounded-xl">
        <div className="flex-1">
          <p className="text-[10px] font-black text-gray-900 dark:text-white uppercase tracking-widest">{'Record as Supplier Bill'}</p>
          <p className="text-[9px] text-gray-500 dark:text-gray-500 mt-0.5">{'Creates payable in supplier ledger'}</p>
        </div>
        <ToggleSwitch

        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-gray-600 dark:text-gray-500 uppercase tracking-widest ml-1">{"Qty (+/-) *"}</label>
              <div className="flex items-center w-full bg-[#f8f9fa] dark:bg-black/75 rounded-xl px-4 py-2 border border-transparent focus-within:border-amber-500/50 focus-within:ring-2 focus-within:ring-amber-500/20 transition-all">
                <input
                  type="number"
                  value={adjustmentData.quantity}
                  onChange={(e) => setAdjustmentData({ ...adjustmentData, quantity: e.target.value })}
                  className="w-full bg-transparent border-none text-left text-xl font-black outline-none dark:text-white min-w-0 py-2"
                  placeholder="-5 or 5"
                />
              </div>
            </div>
            <div className="space-y-2 relative z-30">
              <label className="text-[10px] font-black text-gray-600 dark:text-gray-500 uppercase tracking-widest ml-1">{"Reason *"}</label>
              <SearchableSelect
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-gray-600 dark:text-gray-500 uppercase tracking-widest ml-1">{"Audit Notes"}</label>
            <textarea
      ...
      >
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-gray-600 dark:text-gray-500 uppercase tracking-widest ml-1">{"Qty to Add *"}</label>
              <input
                type="number"
                min="1"
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-gray-600 dark:text-gray-500 uppercase tracking-widest ml-1">{"Cost Price"}</label>
              <input
                type="number"
                min="0"
                step="0.01"
            ...
            <div className="space-y-2 relative z-30 md:col-span-2">
              <label className="text-[10px] font-black text-gray-600 dark:text-gray-500 uppercase tracking-widest ml-1">{"Supplier *"}</label>
              <SearchableSelect
              ...
              {!restockData.supplier.trim() && (
                <p className="text-[10px] font-bold text-rose-500 ml-1">{"A supplier is required to record this stock entry"}</p>
              )}
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/5 rounded-2xl p-4">
            <div>
              <p className="text-[9px] font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest">{"Estimated Total"}</p>
